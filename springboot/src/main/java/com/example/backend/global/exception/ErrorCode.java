...
public enum ErrorCode {
    ...
    CURRENT_PASSWORD_MISMATCH(HttpStatus.BAD_REQUEST, "AUTH_CURRENT_PASSWORD_MISMATCH", "현재 비밀번호가 올바르지 않습니다."),
    PASSWORD_CHANGE_NOT_SUPPORTED(HttpStatus.BAD_REQUEST, "AUTH_PASSWORD_CHANGE_NOT_SUPPORTED", "소셜 로그인 계정은 비밀번호를 변경할 수 없습니다."),
